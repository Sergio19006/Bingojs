...
},{"buffer":"../../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"js/index.js":[function(require,module,exports) {
"use strict";
...
function createCard() {
  var i = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 15;

  var values = _lodash.default.range(0, 90);
...
function fillCard(player) {
  ...
  player.forEach(function (element) {
    ...
    number.className = "number number".concat(element);
